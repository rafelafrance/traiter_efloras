        ...
        self.assertEqual(
            ...
            [{'part': 'sepal', 'trait': 'part',
             ...
             {'color': 'green', 'trait': 'color', 'part': 'sepal',
              'start': 14, 'end': 20},
             {'color': 'red-tipped', 'trait': 'color', 'part': 'sepal',
              'start': 24, 'end': 34}]
        )
    ...
    def test_color_05(self):
        ...
        self.assertEqual(
            ...
            [{'part': 'petal', 'trait': 'part',
             ...
             {'color': 'white', 'trait': 'color', 'part': 'petal',
              'start': 26, 'end': 31},
             {'color': 'green-yellow', 'trait': 'color', 'part': 'petal',
              'start': 33, 'end': 48},
             {'color': 'yellow', 'trait': 'color', 'part': 'petal',
              'start': 59, 'end': 68},
    ...
    def test_color_06(self):
        self.assertEqual(
            ...
            [{'part': 'petal', 'trait': 'part',
             ...
             {'color': 'white', 'trait': 'color', 'part': 'petal',
              'start': 26, 'end': 31},
             {'color': 'green-white', 'trait': 'color', 'part': 'petal',
              'start': 33, 'end': 47},
             {'color': 'yellow-green', 'trait': 'color', 'part': 'petal',
              'start': 52, 'end': 67},
             {'color': 'yellow', 'trait': 'color', 'part': 'petal',
              'start': 72, 'end': 81},
        ...
        self.assertEqual(
            ...
            [{'part': 'leaf', 'trait': 'part',
             ...
             {'color': 'white',
              ...
              'start': 38, 'end': 43},
             {'subpart': 'hair', 'part': 'leaf', 'trait': 'subpart',
              'start': 44, 'end': 49}]
        )
