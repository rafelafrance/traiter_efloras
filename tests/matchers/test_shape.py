...
class TestShape(unittest.TestCase):
    ...
    def test_shape_02(self):
        self.assertEqual(
            ...
            {'part': [{'start': 0, 'end': 4, 'value': 'leaf'}],
             'leaf_shape': [
                 {'value': 'ovate-orbicular', 'start': 5, 'end': 23}]}
        )
    ...
    def test_shape_03(self):
        self.assertEqual(
            ...
            {'part': [{'start': 0, 'end': 9, 'value': 'petiole'}],
             'petiole_shape': [
    ...
    def test_shape_09(self):
        self.assertEqual(
            ...
            {'part': [{'start': 0, 'end': 11, 'value': 'leaf'},
                      {'start': 17, 'end': 21, 'value': 'apex'}],
             'apex_shape': [{'value': 'orbicular', 'start': 22, 'end': 29}]}
        )
    ...
    def test_shape_10(self):
        self.assertEqual(
            ...
            {'part': [{'value': 'leaf', 'start': 0, 'end': 11}],
             'leaf_shape': [{'value': 'orbicular', 'start': 12, 'end': 29}]}
        )
    ...
    def test_shape_11(self):
        self.assertEqual(
            ...
            {'part': [{'start': 0, 'end': 6, 'value': 'leaf'},
                      ...
                      {'start': 16, 'end': 21, 'value': 'leaf'}],
             'leaf_shape': [{'value': 'polygonal', 'start': 22, 'end': 41},
                            {'value': 'reniform-polygonal', 'start': 45,
                             'end': 62},
    ...
    def test_shape_15(self):
        self.assertEqual(
            ...
            {'part': [{'value': 'leaf', 'start': 0, 'end': 5}],
             'leaf_shape': [{'value': 'polygonal', 'start': 6, 'end': 17}]}
        )
