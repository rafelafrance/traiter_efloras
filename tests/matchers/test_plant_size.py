    ...
    def off_test_parse_14(self):
        ...
        self.assertEqual(
            ...
            [Trait(start=0, end=23, location='terminal', part='leaflet',
                   units='mm', low_length=30, high_length=50)])

    def off_test_parse_15(self):
    ...
    def off_test_parse_17(self):
        ...
        self.assertEqual(
            ...
            [Trait(start=0, end=42, part='blade', dimension='wide',
                   units='mm', low_length=20, high_length=60)])

    def off_test_parse_18(self):
        """It allows an 'up to' type of size notation."""
        self.assertEqual(
            PLANT_SIZE.parse('petiole to 11 cm;'),
            [Trait(start=0, end=16, part='petiole', units='mm',
                   high_length=110)])

    def off_test_parse_19(self):
