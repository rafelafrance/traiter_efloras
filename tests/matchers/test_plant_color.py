...
class TestPlantColor(unittest.TestCase):
    ...
    def test_plant_color_01(self):
        ...
        self.assertEqual(
            actual['part'],
            [
                {'value': 'hypanthium', 'start': 0,
                 'end': 10, 'raw_value': 'hypanthium'}
            ])
        self.assertEqual(
            actual['hypanthium_color'],
            [
                {'value': 'green', 'start': 11, 'end': 16,
                 'raw_value': 'green'},
                {'value': 'green-yellow', 'start': 20, 'end': 35,
                 'raw_value': 'greenish yellow'},
                {'value': 'purple-spotted', 'start': 49, 'end': 63,
                 'raw_value': 'purple-spotted'},
                {'value': 'purple-spotted', 'start': 72, 'end': 86,
                 'raw_value': 'purple-spotted'},
            ]
        )
        self.assertEqual(
    ...
    def test_plant_color_02(self):
        ...
        self.assertEqual(
            ...
            [{'part': [{'value': 'hypanthium', 'start': 0,
                        'end': 10, 'raw_value': 'hypanthium'}],
              'hypanthium_color': [
                  {'value': 'yellow', 'start': 11, 'end': 24,
    ...
    def test_plant_color_03(self):
        ...
        self.assertEqual(
            Base().parse('sepals erect, green- or red-tipped'),
            [{'part': [{'value': 'sepal', 'start': 0, 'end': 6,
                        'raw_value': 'sepals'}],
              'sepal_color': [
                  {'value': 'green', 'start': 14, 'end': 20,
                   'raw_value': 'green-'},
    ...
    def test_plant_color_04(self):
        ...
        self.assertEqual(
            ...
            [{'part': [{'value': 'petal', 'start': 0, 'end': 6,
                        'raw_value': 'petals'}], 'petal_color': [
                {'value': 'white', 'start': 34, 'end': 39,
                 'raw_value': 'white'},
                {'value': 'white', 'start': 41, 'end': 46,
                 'raw_value': 'cream'},
                {'value': 'green', 'start': 56, 'end': 61,
                 'raw_value': 'green'},
                {'value': 'orange', 'start': 63, 'end': 69,
                 'raw_value': 'orange'},
                {'value': 'yellow', 'start': 73, 'end': 79,
                 'raw_value': 'yellow'}]
              }])
    ...
    def test_plant_color_05(self):
        ...
        self.assertEqual(
            ...
            [{'part': [{'value': 'petal', 'start': 0, 'end': 6,
                        'raw_value': 'petals'}], 'petal_color': [
                {'value': 'white', 'start': 20, 'end': 25,
                 'raw_value': 'white'},
                {'value': 'white', 'start': 29, 'end': 34,
                 'raw_value': 'cream'},
                {'value': 'green-yellow', 'start': 71, 'end': 86,
                 'raw_value': 'greenish yellow'},
                {'value': 'yellow', 'start': 97, 'end': 106,
                 'raw_value': 'yellowish'},
                {'value': 'brown', 'start': 115, 'end': 120,
                 'raw_value': 'brown'},
                {'value': 'green', 'start': 153, 'end': 158,
                 'raw_value': 'green'},
                {'value': 'white-longitudinal-stripes', 'start': 162,
                 'end': 188,
                 'raw_value': 'white longitudinal stripes'}],
              'petal_shape': [
                  {'value': 'obovate-oblong', 'start': 36, 'end': 61,
                   'raw_value': 'obovate to oblong-obovate'}]}])
    ...
    def test_plant_color_06(self):
        ...
        self.assertEqual(
            ...
            [{'part': [{'value': 'petal', 'start': 0, 'end': 6,
                ...
                {'value': 'white', 'start': 29, 'end': 34,
                 'raw_value': 'cream'},
                {'value': 'green-white', 'start': 36, 'end': 50,
                 'raw_value': 'greenish white'},
                {'value': 'yellow-green', 'start': 55, 'end': 70,
                 'raw_value': 'yellowish green'},
                {'value': 'yellow', 'start': 75, 'end': 84,
                 'raw_value': 'yellowish'},
                {'value': 'green-throated', 'start': 94, 'end': 108,
                 'raw_value': 'green-throated'},
                {'value': 'green-lined', 'start': 121, 'end': 132,
                 'raw_value': 'green-lined'}]}])

    def test_plant_color_07(self):
        """It parses calyx color."""
        self.assertEqual(
            Base('caylx_color').parse('calyx yellow'),
            [{'part': [{'value': 'calyx', 'start': 0, 'end': 5,
                        'raw_value': 'calyx'}],
              'calyx_color': [
                  {'value': 'yellow', 'start': 6, 'end': 12,
                   'raw_value': 'yellow'}]}])
    ...
    def test_plant_color_09(self):
        ...
        self.assertEqual(
            ...
            [{'part': [{'value': 'flower', 'start': 0,
                        'end': 6, 'raw_value': 'flower'}],
              'flower_color': [
                  {'value': 'yellow', 'start': 7, 'end': 13,
                   'raw_value': 'yellow'}]}])
    ...
    def test_plant_color_11(self):
        ...
        self.assertEqual(
            ...
            [{'part': [{'value': 'petal', 'start': 0,
                        'end': 5, 'raw_value': 'petal'}],
              'petal_color': [
                  {'value': 'yellow', 'start': 6, 'end': 12,
                   'raw_value': 'yellow'}]}])
    ...
    def test_plant_color_12(self):
        ...
        self.assertEqual(
            ...
            [{'part': [{'value': 'sepal', 'start': 0,
                        'end': 5, 'raw_value': 'sepal'}],
              'sepal_color': [
                  {'value': 'yellow', 'start': 6, 'end': 12,
                   'raw_value': 'yellow'}]}])
