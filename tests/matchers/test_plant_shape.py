...
class TestPlantShape(unittest.TestCase):
    ...
    def test_plant_shape_01(self):
        """It finds a shape."""
        self.assertEqual(
            Base().parse('leaf suborbiculate'),
            [Trait(start=5, end=18, part='leaf', value=['orbicular'],
                   raw_value='suborbiculate')])

    def test_plant_shape_02(self):
        """It combines shapes."""
        self.assertEqual(
            Base().parse('leaf ovate-suborbicular'),
            [Trait(start=5, end=23, part='leaf', value=['ovate-orbicular'],
                   raw_value='ovate-suborbicular')])

    def test_plant_shape_03(self):
        """It gets a shape starter word."""
        self.assertEqual(
            Base().parse('petiolule 3–12 mm, narrowly oblanceolate,'),
            [Trait(start=19, end=40, part='petiolule', value=['oblanceolate'],
    ...
    def test_plant_shape_04(self):
        ...
        self.assertEqual(
            ...
            [Trait(start=15, end=63, part='blade',
    ...
    def test_plant_shape_05(self):
        ...
        self.assertEqual(
            ...
            [Trait(start=14, end=77, part='blade',
    ...
    def test_plant_shape_06(self):
        ...
        self.assertEqual(
            Base().parse('Leaves: blade broadly to shallowly triangular'),
            [Trait(start=14, end=45, part='blade', value=['triangular'],
    ...
    def test_plant_shape_07(self):
        ...
        self.assertEqual(
            ...
            [Trait(start=43, end=103, part='blade',
    ...
    def test_plant_shape_08(self):
        ...
        self.assertEqual(
            Base().parse('blade deeply pedately 3-lobed'),
            [])
    ...
    def test_plant_shape_10(self):
        ...
        self.assertEqual(
            Base().parse('Leaf blades 2–7 cm wide, lobe apex rounded'),
    ...
    def test_plant_shape_18(self):
        ...
        self.assertEqual(
            Base().parse('hypanthium cupulate'),
    ...
    def test_plant_shape_22(self):
        ...
        self.assertEqual(
            Base().parse('sepals linear-subulate, 3–5 mm; '),
    ...
    def test_plant_shape_26(self):
        ...
        self.assertEqual(
            Base().parse('Leaves in basal rosette and cauline'),
