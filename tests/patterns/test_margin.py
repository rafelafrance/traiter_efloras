        ...
        self.assertEqual(
            ...
            [{'subpart': 'margin', 'trait': 'subpart', 'start': 0, 'end': 6},
             {'margin_shape': 'undulate-crenate',
              'trait': 'margin_shape', 'subpart': 'margin', 'start': 7, 'end': 33}]
        )
    ...
    def test_margin_02(self):
        ...
        self.assertEqual(
            ...
            [{'subpart': 'margin', 'trait': 'subpart', 'start': 0, 'end': 7},
             {'margin_shape': 'ciliate', 'trait': 'margin_shape', 'subpart': 'margin',
              'start': 8, 'end': 15},
             {'subpart': 'apex', 'trait': 'subpart', 'start': 17, 'end': 21},
             {'shape': 'acute', 'trait': 'shape', 'subpart': 'apex',
              'start': 22, 'end': 27},
             {'shape': 'acuminate', 'trait': 'shape', 'subpart': 'apex',
              'start': 31, 'end': 45}]
        )
    ...
    def test_margin_03(self):
        self.assertEqual(
            ...
            [{'shape': 'reniform', 'trait': 'shape', 'start': 0, 'end': 8},
             {'margin_shape': 'undulate', 'trait': 'margin_shape',
              'start': 10, 'end': 27}]
        )
        ...
        self.assertEqual(
            ...
            [{'subpart': 'margin', 'trait': 'subpart', 'start': 0, 'end': 7},
             {'margin_shape': 'corrugated',
              'trait': 'margin_shape', 'subpart': 'margin', 'start': 8, 'end': 28}]
        )
        ...
        self.assertEqual(
            ...
            [{'subpart': 'margin', 'trait': 'subpart', 'start': 0, 'end': 7},
             {'margin_shape': 'toothed',
              'trait': 'margin_shape', 'subpart': 'margin', 'start': 8, 'end': 24},
             {'margin_shape': 'sinuate-dentate',
              'trait': 'margin_shape', 'subpart': 'margin', 'start': 28, 'end': 52},
             {'margin_shape': 'serrate',
              'trait': 'margin_shape', 'subpart': 'margin', 'start': 56, 'end': 63}]
        )
