...
# from traiter.consts import COMMA, DOT
# from traiter.util import DotDict
#
# from ..patterns.descriptor import DESCRIPTOR_LABELS
#
...
#     {
#         'label': 'attach',
#         'on_match': 'attach_final_suffix.v1',
#         'patterns': [
#             [
#                 {'LOWER': 'and'},
#                 {'_': {'step': TRAIT_STEP}},
